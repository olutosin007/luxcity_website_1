    ...
    <>
      ...
      >
        <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[100vh]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 w-full pt-[220px] pb-20 md:pt-[120px] md:pb-16">
            <div className="animate-fade-in md:text-center lg:text-left z-30 relative mt-[60px]">
